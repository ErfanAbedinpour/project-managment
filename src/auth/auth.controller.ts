...
import { CreateUserResponse, LoginResponse, LogOutResponse, RefreshTokenResponse } from "./dtos/auth.response.dto";
...
export class AuthController {
    ...
    @ApiCreatedResponse({ description: "user created succesfully", type: CreateUserResponse })
    ...
    @Post('login')
    async login(@Body() body: LoginUserDTO, @Res({ passthrough: true }) res: Response): Promise<LoginResponse> {
        try {
    ...
    async logout(@Body() body: RefreshTokenDto, @Res({ passthrough: true }) res: Response): Promise<LogOutResponse> {
        try {

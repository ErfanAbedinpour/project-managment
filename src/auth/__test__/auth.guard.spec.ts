...
import { ExecutionContext, ForbiddenException, SetMetadata, UnauthorizedException } from "@nestjs/common";
...
describe("AccessToken gurad ", () => {
    ...
    it("thorw an Error if accessToken gurad throw Error", () => {
        ...
        accessTokenGurad.canActivate.mockRejectedValueOnce(new UnauthorizedException(""));
        reflector.getAllAndOverride.mockImplementationOnce((token: string, handlers: Function[]) => {
